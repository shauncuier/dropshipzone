...
class Admin_UI {
    ...
    public function register_menu() {
        // Main menu
        add_menu_page(
            __('Dropshipzone Sync', '3s-product-sync-for-dropshipzone'),
            __('DSZ Sync', '3s-product-sync-for-dropshipzone'),
            'manage_woocommerce',
            'dsz-sync',
        ...
        add_submenu_page(
            'dsz-sync',
            __('Dashboard', '3s-product-sync-for-dropshipzone'),
            __('Dashboard', '3s-product-sync-for-dropshipzone'),
            'manage_woocommerce',
            'dsz-sync',
            [$this, 'render_dashboard']
        ...
        add_submenu_page(
            'dsz-sync',
            __('API Settings', '3s-product-sync-for-dropshipzone'),
            __('API Settings', '3s-product-sync-for-dropshipzone'),
            'manage_woocommerce',
            'dsz-sync-api',
        ...
        add_submenu_page(
            'dsz-sync',
            __('Price Rules', '3s-product-sync-for-dropshipzone'),
            __('Price Rules', '3s-product-sync-for-dropshipzone'),
            'manage_woocommerce',
            'dsz-sync-price',
        ...
        add_submenu_page(
            'dsz-sync',
            __('Stock Rules', '3s-product-sync-for-dropshipzone'),
            __('Stock Rules', '3s-product-sync-for-dropshipzone'),
            'manage_woocommerce',
            'dsz-sync-stock',
        ...
        add_submenu_page(
            'dsz-sync',
            __('Sync Center', '3s-product-sync-for-dropshipzone'),
            __('Sync Center', '3s-product-sync-for-dropshipzone'),
            'manage_woocommerce',
            'dsz-sync-control',
        ...
        add_submenu_page(
            'dsz-sync',
            __('Logs', '3s-product-sync-for-dropshipzone'),
            __('Logs', '3s-product-sync-for-dropshipzone'),
            'manage_woocommerce',
            'dsz-sync-logs',
            [$this, 'render_logs']
        ...
        add_submenu_page(
            'dsz-sync',
            __('Product Mapping', '3s-product-sync-for-dropshipzone'),
            __('Product Mapping', '3s-product-sync-for-dropshipzone'),
            'manage_woocommerce',
            'dsz-sync-mapping',
            [$this, 'render_mapping']
        ...
        add_submenu_page(
            'dsz-sync',
            __('Product Import', '3s-product-sync-for-dropshipzone'),
            __('Product Import', '3s-product-sync-for-dropshipzone'),
            'manage_woocommerce',
            'dsz-sync-import',
            [$this, 'render_import']
        ...
        add_submenu_page(
            'dsz-sync',
            __('Auto Import', '3s-product-sync-for-dropshipzone'),
            __('Auto Import', '3s-product-sync-for-dropshipzone'),
            'manage_woocommerce',
    ...
    public function enqueue_assets($hook) {
        ...
        wp_localize_script('dsz-admin-js', 'dsz_admin', [
            ...
            'strings' => [
                'testing' => __('Testing connection...', '3s-product-sync-for-dropshipzone'),
                'saving' => __('Saving...', '3s-product-sync-for-dropshipzone'),
                'syncing' => __('Syncing...', '3s-product-sync-for-dropshipzone'),
                'success' => __('Success!', '3s-product-sync-for-dropshipzone'),
                'error' => __('Error occurred', '3s-product-sync-for-dropshipzone'),
                'confirm_clear' => __('Are you sure you want to clear all logs?', '3s-product-sync-for-dropshipzone'),
                'confirm_never_synced' => __('This will resync all never-synced products. Continue?', '3s-product-sync-for-dropshipzone'),
                'confirm_scan' => __('This will check all unmapped products against Dropshipzone API. Products found will be linked; products not found will be marked as Non-DSZ. Continue?', '3s-product-sync-for-dropshipzone'),
                'processing' => __('Processing...', '3s-product-sync-for-dropshipzone'),
                'scanning' => __('Scanning products...', '3s-product-sync-for-dropshipzone'),
                'resynced' => __('Resynced', '3s-product-sync-for-dropshipzone'),
                'errors_word' => __('errors', '3s-product-sync-for-dropshipzone'),
                'processed' => __('processed...', '3s-product-sync-for-dropshipzone'),
                'linked' => __('linked', '3s-product-sync-for-dropshipzone'),
                'non_dsz' => __('marked as non-DSZ', '3s-product-sync-for-dropshipzone'),
                'scanned' => __('scanned...', '3s-product-sync-for-dropshipzone'),
                'importing' => __('Importing...', '3s-product-sync-for-dropshipzone'),
                'submitting' => __('Submitting...', '3s-product-sync-for-dropshipzone'),
                'request_failed' => __('Request failed', '3s-product-sync-for-dropshipzone'),
                'rate_wait' => __('Rate limit reached — retrying shortly...', '3s-product-sync-for-dropshipzone'),
                'confirm_ok' => __('Confirm', '3s-product-sync-for-dropshipzone'),
                'confirm_cancel' => __('Cancel', '3s-product-sync-for-dropshipzone'),
            ],
        ]);
    }
    ...
    private function render_header($title, $subtitle = '') {
        ...
        $nav_items = [
            // Overview
            'dsz-sync' => [
                'label' => __('Dashboard', '3s-product-sync-for-dropshipzone'),
                'icon' => 'dashicons-dashboard'
            ],
            // 1. First: Configure API
            'dsz-sync-api' => [
                'label' => __('API Settings', '3s-product-sync-for-dropshipzone'),
                'icon' => 'dashicons-admin-network'
            ],
            // 2. Products: Import first, then map
            'dsz-sync-import' => [
                'label' => __('Import Products', '3s-product-sync-for-dropshipzone'),
                'icon' => 'dashicons-download'
            ],
            'dsz-sync-auto-import' => [
                'label' => __('Auto Import', '3s-product-sync-for-dropshipzone'),
                'icon' => 'dashicons-controls-repeat'
            ],
            'dsz-sync-mapping' => [
                'label' => __('Product Mapping', '3s-product-sync-for-dropshipzone'),
                'icon' => 'dashicons-admin-links'
            ],
            // 3. Rules: Configure pricing and stock
            'dsz-sync-price' => [
                'label' => __('Price Rules', '3s-product-sync-for-dropshipzone'),
                'icon' => 'dashicons-money-alt'
            ],
            'dsz-sync-stock' => [
                'label' => __('Stock Rules', '3s-product-sync-for-dropshipzone'),
                'icon' => 'dashicons-archive'
            ],
            // 4. Operations: Run sync and view logs
            'dsz-sync-control' => [
                'label' => __('Sync Center', '3s-product-sync-for-dropshipzone'),
                'icon' => 'dashicons-update'
            ],
            'dsz-sync-logs' => [
                'label' => __('Logs', '3s-product-sync-for-dropshipzone'),
        ...
        <div class="dsz-header">
            <div class="dsz-header-content">
                ...
                <button type="button" id="dsz-theme-toggle" class="button dsz-theme-toggle" title="<?php esc_attr_e('Toggle light/dark theme', '3s-product-sync-for-dropshipzone'); ?>">
    ...
    public function render_dashboard() {
        if (!dsz_current_user_can_manage()) {
            wp_die(esc_html__('You do not have permission to access this page.', '3s-product-sync-for-dropshipzone'));
        }
        ...
        <div class="wrap dsz-wrap">
            <?php $this->render_header(__('Dropshipzone Sync Dashboard', '3s-product-sync-for-dropshipzone')); ?>
            ...
            <div class="dsz-dashboard">
                ...
                <div class="dsz-cards">
                    <div class="dsz-card dsz-card-status <?php echo esc_attr($token_status['is_valid'] ? 'dsz-card-success' : 'dsz-card-error'); ?>">
                        ...
                        <div class="dsz-card-content">
                            <h3><?php esc_html_e('API Status', '3s-product-sync-for-dropshipzone'); ?></h3>
                            <p class="dsz-card-value">
                                <?php echo esc_html($token_status['is_valid'] ? __('Connected', '3s-product-sync-for-dropshipzone') : __('Not Connected', '3s-product-sync-for-dropshipzone')); ?>
                            </p>
                            <?php if ($token_status['is_valid'] && $token_status['expires_in'] > 0): ?>
                                <?php /* translators: %s: time difference */ ?>
                                <p class="dsz-card-meta"><?php printf(esc_html__('Expires in %s', '3s-product-sync-for-dropshipzone'), esc_html(human_time_diff(time(), time() + $token_status['expires_in']))); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="dsz-card">
                        ...
                        <div class="dsz-card-content">
                            <h3><?php esc_html_e('Last Sync', '3s-product-sync-for-dropshipzone'); ?></h3>
                            <p class="dsz-card-value">
                                <?php echo $sync_status['last_sync'] ? esc_html(dsz_time_ago($sync_status['last_sync'])) : esc_html__('Never', '3s-product-sync-for-dropshipzone'); ?>
                            </p>
                            <?php if ($sync_status['next_scheduled']): ?>
                                <?php /* translators: %s: date time */ ?>
                                <p class="dsz-card-meta"><?php printf(esc_html__('Next: %s', '3s-product-sync-for-dropshipzone'), esc_html(dsz_format_datetime($sync_status['next_scheduled']))); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="dsz-card">
                        ...
                        <div class="dsz-card-content">
                            <h3><?php esc_html_e('Products Updated', '3s-product-sync-for-dropshipzone'); ?></h3>
                            <p class="dsz-card-value"><?php echo intval($sync_status['last_products_updated']); ?></p>
                            <p class="dsz-card-meta"><?php esc_html_e('Last sync run', '3s-product-sync-for-dropshipzone'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="dsz-card <?php echo esc_attr($error_count > 0 ? 'dsz-card-warning' : ''); ?>">
                        ...
                        <div class="dsz-card-content">
                            <h3><?php esc_html_e('Errors', '3s-product-sync-for-dropshipzone'); ?></h3>
                            <p class="dsz-card-value"><?php echo intval($error_count); ?></p>
                            <p class="dsz-card-meta">
                                <a href="<?php echo esc_url(admin_url('admin.php?page=dsz-sync-logs&level=error')); ?>"><?php esc_html_e('View Logs', '3s-product-sync-for-dropshipzone'); ?></a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="dsz-section">
                    <h2><?php esc_html_e('Quick Actions', '3s-product-sync-for-dropshipzone'); ?></h2>
                ...
                <div class="dsz-section dsz-sync-progress-section">
                    <h2><?php esc_html_e('Sync in Progress', '3s-product-sync-for-dropshipzone'); ?></h2>
                    <div class="dsz-progress-wrapper">
                        ...
                        <p class="dsz-progress-text">
                            ...
                            <?php printf(esc_html__('Processing... %s%%', '3s-product-sync-for-dropshipzone'), esc_html($this->cron->get_progress())); ?>
                        </p>
                    </div>
                </div>
                <?php endif; ?>
    ...
    public function render_api_settings() {
        ...
        ?>
        <div class="wrap dsz-wrap">
            <?php $this->render_header(__('API Settings', '3s-product-sync-for-dropshipzone'), __('Configure your Dropshipzone API credentials', '3s-product-sync-for-dropshipzone')); ?>
            ...
            <div class="dsz-content">
                <form id="dsz-api-form" class="dsz-form">
                    ...
                    <div class="dsz-form-section">
                        <h2><?php esc_html_e('API Credentials', '3s-product-sync-for-dropshipzone'); ?></h2>
                        
                        <table class="form-table">
                            <tr>
                                <th scope="row">
                                    <label for="dsz_api_email"><?php esc_html_e('API Email', '3s-product-sync-for-dropshipzone'); ?></label>
                                </th>
                                <td>
                                    <input type="email" id="dsz_api_email" name="dsz_api_email" value="<?php echo esc_attr($email); ?>" class="regular-text" />
                                    <p class="description"><?php esc_html_e('Your Dropshipzone account email', '3s-product-sync-for-dropshipzone'); ?></p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                    <label for="dsz_api_password"><?php esc_html_e('API Password', '3s-product-sync-for-dropshipzone'); ?></label>
                                </th>
                                <td>
                                    ...
                                    <p class="description"><?php esc_html_e('Your Dropshipzone account password (stored securely)', '3s-product-sync-for-dropshipzone'); ?></p>
                                </td>
                            </tr>
                        </table>
                        ...
                        <div class="dsz-form-actions">
                            <button type="button" id="dsz-test-connection" class="button button-secondary">
                                <span class="dashicons dashicons-admin-network"></span>
                                <?php esc_html_e('Test Connection', '3s-product-sync-for-dropshipzone'); ?>
                            </button>
                            <button type="submit" class="button button-primary">
                                <span class="dashicons dashicons-saved"></span>
                                <?php esc_html_e('Save Settings', '3s-product-sync-for-dropshipzone'); ?>
                            </button>
                        </div>
                    ...
                    <!-- Import Settings -->
                    <div class="dsz-form-section">
                        <h2><?php esc_html_e('Import Settings', '3s-product-sync-for-dropshipzone'); ?></h2>
                        <?php 
                        ...
                        <table class="form-table">
                            <tr>
                                <th scope="row">
                                    <label for="dsz_import_status"><?php esc_html_e('Default Product Status', '3s-product-sync-for-dropshipzone'); ?></label>
                                </th>
                                <td>
                                    <select id="dsz_import_status" name="dsz_import_status" class="dsz-import-status-select">
                                        <option value="publish" <?php selected($default_status, 'publish'); ?>><?php esc_html_e('Published', '3s-product-sync-for-dropshipzone'); ?></option>
                                        <option value="draft" <?php selected($default_status, 'draft'); ?>><?php esc_html_e('Draft', '3s-product-sync-for-dropshipzone'); ?></option>
                                    </select>
                                    <p class="description"><?php esc_html_e('New products will be created with this status.', '3s-product-sync-for-dropshipzone'); ?></p>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <!-- Token Status -->
                    <div class="dsz-form-section">
                        <h2><?php esc_html_e('Connection Status', '3s-product-sync-for-dropshipzone'); ?></h2>
                        <div class="dsz-status-box <?php echo esc_attr($token_status['is_valid'] ? 'dsz-status-success' : 'dsz-status-warning'); ?>">
                            <span class="dashicons <?php echo esc_attr($token_status['is_valid'] ? 'dashicons-yes-alt' : 'dashicons-warning'); ?>"></span>
                            <div>
                                <strong><?php echo esc_html($token_status['is_valid'] ? __('Connected', '3s-product-sync-for-dropshipzone') : __('Not Connected', '3s-product-sync-for-dropshipzone')); ?></strong>
                                <?php if ($token_status['is_valid']): ?>
                                    <?php /* translators: %s: date time */ ?>
                                    <p><?php printf(esc_html__('Token expires: %s', '3s-product-sync-for-dropshipzone'), esc_html(dsz_format_datetime($token_status['expires_at']))); ?></p>
                                <?php else: ?>
                                    <p><?php esc_html_e('Please enter your credentials and test the connection.', '3s-product-sync-for-dropshipzone'); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
    ...
    public function render_price_rules() {
        ...
        ?>
        <div class="wrap dsz-wrap">
            <?php $this->render_header(__('Price Rules', '3s-product-sync-for-dropshipzone'), __('Configure how prices are calculated from supplier cost', '3s-product-sync-for-dropshipzone')); ?>
            ...
            <div class="dsz-content">
                <form id="dsz-price-form" class="dsz-form" data-type="price_rules">
                    ...
                    <div class="dsz-form-section">
                        <h2><?php esc_html_e('Markup Settings', '3s-product-sync-for-dropshipzone'); ?></h2>
                        
                        <table class="form-table">
                            <tr>
                                <th scope="row"><?php esc_html_e('Markup Type', '3s-product-sync-for-dropshipzone'); ?></th>
                                <td>
                                    <label>
                                        <input type="radio" name="markup_type" value="percentage" <?php checked($rules['markup_type'], 'percentage'); ?> />
                                        <?php esc_html_e('Percentage', '3s-product-sync-for-dropshipzone'); ?>
                                    </label>
                                    <label class="dsz-ml-3">
                                        <input type="radio" name="markup_type" value="fixed" <?php checked($rules['markup_type'], 'fixed'); ?> />
                                        <?php esc_html_e('Fixed Amount', '3s-product-sync-for-dropshipzone'); ?>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                    <label for="markup_value"><?php esc_html_e('Markup Value', '3s-product-sync-for-dropshipzone'); ?></label>
                                </th>
                                <td>
                                    ...
                                    <p class="description"><?php esc_html_e('Enter percentage (e.g., 30 for 30%) or fixed amount (e.g., 15 for $15)', '3s-product-sync-for-dropshipzone'); ?></p>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="dsz-form-section">
                        <h2><?php esc_html_e('GST Settings', '3s-product-sync-for-dropshipzone'); ?></h2>
                        
                        <table class="form-table">
                            <tr>
                                <th scope="row"><?php esc_html_e('Apply GST', '3s-product-sync-for-dropshipzone'); ?></th>
                                <td>
                                    <label>
                                        <input type="checkbox" name="gst_enabled" value="1" <?php checked($rules['gst_enabled'], true); ?> />
                                        <?php esc_html_e('Enable GST calculation (10%)', '3s-product-sync-for-dropshipzone'); ?>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><?php esc_html_e('GST Mode', '3s-product-sync-for-dropshipzone'); ?></th>
                                <td>
                                    <label>
                                        <input type="radio" name="gst_type" value="include" <?php checked($rules['gst_type'], 'include'); ?> />
                                        <?php esc_html_e('Supplier price already includes GST', '3s-product-sync-for-dropshipzone'); ?>
                                    </label><br/>
                                    <label>
                                        <input type="radio" name="gst_type" value="exclude" <?php checked($rules['gst_type'], 'exclude'); ?> />
                                        <?php esc_html_e('Add GST to calculated price', '3s-product-sync-for-dropshipzone'); ?>
                                    </label>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div class="dsz-form-section">
                        <h2><?php esc_html_e('Price Rounding', '3s-product-sync-for-dropshipzone'); ?></h2>
                        
                        <table class="form-table">
                            <tr>
                                <th scope="row"><?php esc_html_e('Enable Rounding', '3s-product-sync-for-dropshipzone'); ?></th>
                                <td>
                                    <label>
                                        <input type="checkbox" name="rounding_enabled" value="1" <?php checked($rules['rounding_enabled'], true); ?> />
                                        <?php esc_html_e('Round prices for cleaner display', '3s-product-sync-for-dropshipzone'); ?>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><?php esc_html_e('Rounding Style', '3s-product-sync-for-dropshipzone'); ?></th>
                                <td>
                                    <select name="rounding_type">
                                        <option value="99" <?php selected($rules['rounding_type'], '99'); ?>><?php esc_html_e('.99 (e.g., $29.99)', '3s-product-sync-for-dropshipzone'); ?></option>
                                        <option value="95" <?php selected($rules['rounding_type'], '95'); ?>><?php esc_html_e('.95 (e.g., $29.95)', '3s-product-sync-for-dropshipzone'); ?></option>
                                        <option value="nearest" <?php selected($rules['rounding_type'], 'nearest'); ?>><?php esc_html_e('Nearest dollar (e.g., $30)', '3s-product-sync-for-dropshipzone'); ?></option>
                                    </select>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div class="dsz-form-section dsz-preview-section">
                        <h2><?php esc_html_e('Price Preview', '3s-product-sync-for-dropshipzone'); ?></h2>
                        <div class="dsz-price-preview">
                            <div class="dsz-preview-input">
                                <label for="preview_price"><?php esc_html_e('Supplier Price:', '3s-product-sync-for-dropshipzone'); ?></label>
                            ...
                            <div class="dsz-preview-result">
                                ...
                                <div class="dsz-preview-final">
                                    <label><?php esc_html_e('Final Price:', '3s-product-sync-for-dropshipzone'); ?></label>
                    ...
                    <div class="dsz-form-actions">
                        <button type="submit" class="button button-primary">
                            <span class="dashicons dashicons-saved"></span>
                            <?php esc_html_e('Save Price Rules', '3s-product-sync-for-dropshipzone'); ?>
                        </button>
                    </div>
                ...
                <div class="dsz-form-section">
                    <div class="dsz-section-header">
                        <h2><?php esc_html_e('Advanced Price Rules', '3s-product-sync-for-dropshipzone'); ?></h2>
                        <button type="button" id="dsz-add-adv-rule" class="button">
                            <span class="dashicons dashicons-plus-alt2"></span>
                            <?php esc_html_e('Add Rule', '3s-product-sync-for-dropshipzone'); ?>
                        </button>
                    </div>
                    <p class="description dsz-mb-4"><?php esc_html_e('Rules are checked top to bottom; the first match overrides the global markup above. GST and rounding settings are inherited from the global rules. Match by Dropshipzone category (numeric ID or path prefix like "Appliances"), supplier ID (vendor_id), or SKU prefix.', '3s-product-sync-for-dropshipzone'); ?></p>

                    <table class="dsz-table" id="dsz-adv-rules-table">
                        <thead>
                            <tr>
                                <th><?php esc_html_e('Name', '3s-product-sync-for-dropshipzone'); ?></th>
                                <th><?php esc_html_e('Match', '3s-product-sync-for-dropshipzone'); ?></th>
                                <th><?php esc_html_e('Value', '3s-product-sync-for-dropshipzone'); ?></th>
                                <th><?php esc_html_e('Markup', '3s-product-sync-for-dropshipzone'); ?></th>
                                <th><?php esc_html_e('Amount', '3s-product-sync-for-dropshipzone'); ?></th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr class="dsz-adv-rule">
                                <td><input type="text" class="dsz-rule-name" value="<?php echo esc_attr(isset($adv_rule['name']) ? $adv_rule['name'] : ''); ?>" placeholder="<?php esc_attr_e('Rule name', '3s-product-sync-for-dropshipzone'); ?>" /></td>
                                <td>
                                    <select class="dsz-rule-match-type">
                                        <option value="category" <?php selected($adv_rule['match_type'], 'category'); ?>><?php esc_html_e('Category', '3s-product-sync-for-dropshipzone'); ?></option>
                                        <option value="supplier" <?php selected($adv_rule['match_type'], 'supplier'); ?>><?php esc_html_e('Supplier ID', '3s-product-sync-for-dropshipzone'); ?></option>
                                        <option value="sku_prefix" <?php selected($adv_rule['match_type'], 'sku_prefix'); ?>><?php esc_html_e('SKU prefix', '3s-product-sync-for-dropshipzone'); ?></option>
                                    </select>
                                </td>
                                ...
                                <td><button type="button" class="button dsz-btn-danger dsz-rule-remove" title="<?php esc_attr_e('Remove rule', '3s-product-sync-for-dropshipzone'); ?>"><span class="dashicons dashicons-no-alt"></span></button></td>
                            </tr>
                            <?php endforeach; ?>
                            <tr class="dsz-adv-rule dsz-adv-rule-proto hidden">
                                <td><input type="text" class="dsz-rule-name" placeholder="<?php esc_attr_e('Rule name', '3s-product-sync-for-dropshipzone'); ?>" /></td>
                                <td>
                                    <select class="dsz-rule-match-type">
                                        <option value="category"><?php esc_html_e('Category', '3s-product-sync-for-dropshipzone'); ?></option>
                                        <option value="supplier"><?php esc_html_e('Supplier ID', '3s-product-sync-for-dropshipzone'); ?></option>
                                        <option value="sku_prefix"><?php esc_html_e('SKU prefix', '3s-product-sync-for-dropshipzone'); ?></option>
                                    </select>
                                </td>
                    ...
                    <div class="dsz-form-actions">
                        <button type="button" id="dsz-save-adv-rules" class="button button-primary">
                            <span class="dashicons dashicons-saved"></span>
                            <?php esc_html_e('Save Advanced Rules', '3s-product-sync-for-dropshipzone'); ?>
                        </button>
                    </div>
    ...
    public function render_stock_rules() {
        ...
        ?>
        <div class="wrap dsz-wrap">
            <?php $this->render_header(__('Stock Rules', '3s-product-sync-for-dropshipzone'), __('Configure how stock quantities are synced', '3s-product-sync-for-dropshipzone')); ?>
            ...
            <div class="dsz-content">
                <form id="dsz-stock-form" class="dsz-form" data-type="stock_rules">
                    ...
                    <div class="dsz-form-section">
                        <h2><?php esc_html_e('Stock Buffer', '3s-product-sync-for-dropshipzone'); ?></h2>
                        
                        <table class="form-table">
                            <tr>
                                <th scope="row"><?php esc_html_e('Enable Stock Buffer', '3s-product-sync-for-dropshipzone'); ?></th>
                                <td>
                                    <label>
                                        <input type="checkbox" name="buffer_enabled" value="1" <?php checked($rules['buffer_enabled'], true); ?> />
                                        <?php esc_html_e('Subtract a buffer amount from supplier stock', '3s-product-sync-for-dropshipzone'); ?>
                                    </label>
                                    <p class="description"><?php esc_html_e('Useful to prevent overselling', '3s-product-sync-for-dropshipzone'); ?></p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                    <label for="buffer_amount"><?php esc_html_e('Buffer Amount', '3s-product-sync-for-dropshipzone'); ?></label>
                                </th>
                                <td>
                                    ...
                                    <p class="description"><?php esc_html_e('Number of units to subtract from supplier stock (e.g., 2 means if supplier has 10, your store shows 8)', '3s-product-sync-for-dropshipzone'); ?></p>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="dsz-form-section">
                        <h2><?php esc_html_e('Out of Stock Handling', '3s-product-sync-for-dropshipzone'); ?></h2>
                        
                        <table class="form-table">
                            <tr>
                                <th scope="row"><?php esc_html_e('Zero Stock on Unavailable', '3s-product-sync-for-dropshipzone'); ?></th>
                                <td>
                                    <label>
                                        <input type="checkbox" name="zero_on_unavailable" value="1" <?php checked($rules['zero_on_unavailable'], true); ?> />
                                        <?php esc_html_e('Set stock to 0 if product is marked unavailable by supplier', '3s-product-sync-for-dropshipzone'); ?>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><?php esc_html_e('Auto Out of Stock', '3s-product-sync-for-dropshipzone'); ?></th>
                                <td>
                                    <label>
                                        <input type="checkbox" name="auto_out_of_stock" value="1" <?php checked($rules['auto_out_of_stock'], true); ?> />
                                        <?php esc_html_e('Automatically set product status to "Out of Stock" when quantity is 0', '3s-product-sync-for-dropshipzone'); ?>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><?php esc_html_e('Deactivate Missing Products', '3s-product-sync-for-dropshipzone'); ?></th>
                                <td>
                                    <label>
                                        ...
                                        <?php esc_html_e('Set products to Draft if not found in Dropshipzone API (discontinued products)', '3s-product-sync-for-dropshipzone'); ?>
                                    </label>
                                    <p class="description"><?php esc_html_e('When a product SKU is no longer available in Dropshipzone, the product will be set to Draft status and stock set to 0.', '3s-product-sync-for-dropshipzone'); ?></p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><?php esc_html_e('Auto-Republish on Restock', '3s-product-sync-for-dropshipzone'); ?></th>
                                <td>
                                    <label>
                                        ...
                                        <?php esc_html_e('Automatically republish Draft products when they come back in stock', '3s-product-sync-for-dropshipzone'); ?>
                                    </label>
                                    <p class="description"><?php esc_html_e('When a product that was set to Draft (due to being out of stock or discontinued) gets stock again, it will be automatically set back to Published.', '3s-product-sync-for-dropshipzone'); ?></p>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="dsz-form-actions">
                        <button type="submit" class="button button-primary">
                            <span class="dashicons dashicons-saved"></span>
                            <?php esc_html_e('Save Stock Rules', '3s-product-sync-for-dropshipzone'); ?>
                        </button>
                    </div>
    ...
    public function render_sync_center() {
        ...
        ?>
        <div class="wrap dsz-wrap">
            <?php $this->render_header(__('Sync Center', '3s-product-sync-for-dropshipzone'), __('All sync actions in one place', '3s-product-sync-for-dropshipzone')); ?>
            ...
            <div class="dsz-sync-dashboard">
                ...
                <div class="dsz-sync-cards">
                    ...
                    <div class="dsz-sync-card <?php echo esc_attr($in_progress ? 'dsz-card-syncing' : 'dsz-card-idle'); ?>">
                        ...
                        <div class="dsz-sync-card-content">
                            <h3><?php esc_html_e('Sync State', '3s-product-sync-for-dropshipzone'); ?></h3>
                            <div class="dsz-sync-card-value" id="sync-status-text">
                                <?php echo esc_html($in_progress ? __('Syncing...', '3s-product-sync-for-dropshipzone') : __('Ready', '3s-product-sync-for-dropshipzone')); ?>
                            </div>
                            <div class="dsz-sync-card-meta">
                                <?php if ($in_progress): ?>
                                    <span class="dsz-pulse-dot"></span> <?php esc_html_e('Processing...', '3s-product-sync-for-dropshipzone'); ?>
                                <?php else: ?>
                                    <?php esc_html_e('All systems ready', '3s-product-sync-for-dropshipzone'); ?>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dsz-sync-card">
                        ...
                        <div class="dsz-sync-card-content">
                            ...
                            <div class="dsz-sync-card-meta">
                                <span class="dsz-text-success"><?php echo intval($sync_status['last_products_updated']); ?> <?php esc_html_e('updated', '3s-product-sync-for-dropshipzone'); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dsz-sync-card">
                        ...
                        <div class="dsz-sync-card-content">
                            <h3><?php esc_html_e('Linked Products', '3s-product-sync-for-dropshipzone'); ?></h3>
                            <div class="dsz-sync-card-value">
                                <?php echo number_format($total_mapped); ?>
                            </div>
                            <div class="dsz-sync-card-meta">
                                <?php if ($unmapped_count > 0): ?>
                                    <span class="dsz-text-warning"><?php echo intval($unmapped_count); ?> <?php esc_html_e('unlinked', '3s-product-sync-for-dropshipzone'); ?></span>
                                <?php else: ?>
                                    <?php esc_html_e('All products linked', '3s-product-sync-for-dropshipzone'); ?>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dsz-sync-card">
                        ...
                        <div class="dsz-sync-card-content">
                            <h3><?php esc_html_e('Next Auto-Sync', '3s-product-sync-for-dropshipzone'); ?></h3>
                            <div class="dsz-sync-card-value">
                                <?php echo $sync_status['next_scheduled'] ? esc_html(dsz_time_ago($sync_status['next_scheduled'])) : esc_html__('Not scheduled', '3s-product-sync-for-dropshipzone'); ?>
                            </div>
                            <div class="dsz-sync-card-meta">
                                <?php 
                                $freq_labels = [
                                    'hourly' => __('Hourly', '3s-product-sync-for-dropshipzone'),
                                    'twicedaily' => __('Twice Daily', '3s-product-sync-for-dropshipzone'),
                                    'daily' => __('Daily', '3s-product-sync-for-dropshipzone'),
                                ];
                ...
                <div class="dsz-sync-actions-grid">
                    ...
                    <div class="dsz-action-card">
                        <div class="dsz-action-card-header">
                            <span class="dashicons dashicons-admin-links"></span>
                            <h3><?php esc_html_e('Link Products', '3s-product-sync-for-dropshipzone'); ?></h3>
                        </div>
                        <p class="dsz-action-card-desc">
                            <?php esc_html_e('Scan your WooCommerce catalog and automatically link products to Dropshipzone using matching SKUs.', '3s-product-sync-for-dropshipzone'); ?>
                        </p>
                        <div class="dsz-action-card-footer">
                            <button type="button" id="dsz-auto-map" class="button button-secondary">
                                <span class="dashicons dashicons-admin-links"></span>
                                <?php esc_html_e('Link Products by SKU', '3s-product-sync-for-dropshipzone'); ?>
                            </button>
                        </div>
                    ...
                    <div class="dsz-action-card dsz-action-card-primary">
                        <div class="dsz-action-card-header">
                            <span class="dashicons dashicons-money-alt"></span>
                            <h3><?php esc_html_e('Update Prices & Stock', '3s-product-sync-for-dropshipzone'); ?></h3>
                        </div>
                        <p class="dsz-action-card-desc">
                            <?php esc_html_e('Sync the latest prices and stock levels from Dropshipzone API for all linked products.', '3s-product-sync-for-dropshipzone'); ?>
                        </p>
                        <div class="dsz-action-card-footer">
                            <button type="button" id="dsz-run-sync" class="button button-primary" <?php echo esc_attr($in_progress ? 'disabled' : ''); ?>>
                                <span class="dashicons dashicons-update-alt"></span>
                                <?php esc_html_e('Update Now', '3s-product-sync-for-dropshipzone'); ?>
                            </button>
                        </div>
                        <!-- Progress Section -->
                        <div id="dsz-progress-container" class="dsz-progress-console <?php echo esc_attr($in_progress ? '' : 'hidden'); ?>">
                            <div class="dsz-progress-stats">
                                <span class="dsz-progress-label"><?php esc_html_e('Progress', '3s-product-sync-for-dropshipzone'); ?></span>
                    ...
                    <div class="dsz-action-card">
                        <div class="dsz-action-card-header">
                            ...
                            <h3><?php esc_html_e('Refresh Images', '3s-product-sync-for-dropshipzone'); ?></h3>
                        </div>
                        <p class="dsz-action-card-desc">
                            <?php esc_html_e('Re-download product images and gallery from Dropshipzone for linked products.', '3s-product-sync-for-dropshipzone'); ?>
                        </p>
                        <div class="dsz-action-card-footer">
                            <button type="button" id="dsz-resync-images" class="button button-secondary">
                                <span class="dashicons dashicons-format-image"></span>
                                <?php esc_html_e('Refresh Images', '3s-product-sync-for-dropshipzone'); ?>
                            </button>
                        </div>
                    ...
                    <div class="dsz-action-card">
                        <div class="dsz-action-card-header">
                            ...
                            <h3><?php esc_html_e('Refresh Categories', '3s-product-sync-for-dropshipzone'); ?></h3>
                        </div>
                        <p class="dsz-action-card-desc">
                            <?php esc_html_e('Update product categories from Dropshipzone for linked products.', '3s-product-sync-for-dropshipzone'); ?>
                        </p>
                        <div class="dsz-action-card-footer">
                            <button type="button" id="dsz-resync-categories" class="button button-secondary">
                                <span class="dashicons dashicons-category"></span>
                                <?php esc_html_e('Refresh Categories', '3s-product-sync-for-dropshipzone'); ?>
                            </button>
                        </div>
                    ...
                    <div class="dsz-action-card">
                        <div class="dsz-action-card-header">
                            ...
                            <h3><?php esc_html_e('Refresh All Data', '3s-product-sync-for-dropshipzone'); ?></h3>
                        </div>
                        <p class="dsz-action-card-desc">
                            <?php esc_html_e('Re-download everything: images, descriptions, categories, price, stock for linked products.', '3s-product-sync-for-dropshipzone'); ?>
                        </p>
                        <div class="dsz-action-card-footer">
                            <button type="button" id="dsz-resync-all" class="button button-secondary">
                                <span class="dashicons dashicons-download"></span>
                                <?php esc_html_e('Refresh All Data', '3s-product-sync-for-dropshipzone'); ?>
                            </button>
                        </div>
                    ...
                    <div class="dsz-action-card">
                        <div class="dsz-action-card-header">
                            ...
                            <h3><?php esc_html_e('Order Automation', '3s-product-sync-for-dropshipzone'); ?></h3>
                        </div>
                        <p class="dsz-action-card-desc">
                            <?php esc_html_e('Submit paid orders to Dropshipzone and pull tracking numbers back automatically.', '3s-product-sync-for-dropshipzone'); ?>
                        </p>
                        <div class="dsz-form-group">
                            <label>
                                <input type="checkbox" id="dsz-order-auto-submit" <?php checked(!empty($order_settings['auto_submit'])); ?> />
                                <?php esc_html_e('Auto-submit orders to DSZ when paid (processing)', '3s-product-sync-for-dropshipzone'); ?>
                            </label>
                            <label>
                                <input type="checkbox" id="dsz-order-autocomplete" <?php checked(!empty($order_settings['tracking_autocomplete'])); ?> />
                                <?php esc_html_e('Complete WC order when DSZ marks it complete', '3s-product-sync-for-dropshipzone'); ?>
                            </label>
                        </div>
                        <div class="dsz-action-card-footer dsz-flex-row">
                            <button type="button" id="dsz-save-order-settings" class="button">
                                <?php esc_html_e('Save', '3s-product-sync-for-dropshipzone'); ?>
                            </button>
                            <button type="button" id="dsz-submit-pending-orders" class="button button-secondary">
                                <span class="dashicons dashicons-upload"></span>
                                <?php esc_html_e('Submit Pending Orders', '3s-product-sync-for-dropshipzone'); ?>
                            </button>
                            <button type="button" id="dsz-run-tracking-sync" class="button button-secondary">
                                <span class="dashicons dashicons-location"></span>
                                <?php esc_html_e('Check Tracking Now', '3s-product-sync-for-dropshipzone'); ?>
                            </button>
                        </div>
                ...
                <div class="dsz-content dsz-sync-settings-full">
                    <form id="dsz-schedule-form" class="dsz-form" data-type="sync_settings">
                        ...
                        <div class="dsz-form-section">
                            <div class="dsz-section-header">
                                <h2><?php esc_html_e('Auto-Sync Schedule', '3s-product-sync-for-dropshipzone'); ?></h2>
                                <p class="description"><?php esc_html_e('Configure automatic price & stock updates.', '3s-product-sync-for-dropshipzone'); ?></p>
                            </div>
                            
                            <div class="dsz-inline-settings">
                                <div class="dsz-form-group">
                                    <label for="frequency"><?php esc_html_e('Interval', '3s-product-sync-for-dropshipzone'); ?></label>
                                ...
                                <div class="dsz-form-group">
                                    <label for="batch_size"><?php esc_html_e('Batch Size', '3s-product-sync-for-dropshipzone'); ?></label>
    ...
    public function render_logs() {
        ...
        ?>
        <div class="wrap dsz-wrap">
            <?php $this->render_header(__('Activity Logs', '3s-product-sync-for-dropshipzone'), __('Monitor sync activity and troubleshoot issues', '3s-product-sync-for-dropshipzone')); ?>
            ...
            <div class="dsz-log-stats">
                <a href="<?php echo esc_url(admin_url('admin.php?page=dsz-sync-logs')); ?>" class="dsz-log-stat-card <?php echo empty($level) ? 'active' : ''; ?>">
                    ...
                    <div class="dsz-log-stat-content">
                        ...
                        <span class="dsz-log-stat-label"><?php esc_html_e('Total Logs', '3s-product-sync-for-dropshipzone'); ?></span>
                    </div>
                </a>
                <a href="<?php echo esc_url(admin_url('admin.php?page=dsz-sync-logs&level=info')); ?>" class="dsz-log-stat-card dsz-log-stat-info <?php echo esc_attr($level === 'info' ? 'active' : ''); ?>">
                    ...
                    <div class="dsz-log-stat-content">
                        ...
                        <span class="dsz-log-stat-label"><?php esc_html_e('Info', '3s-product-sync-for-dropshipzone'); ?></span>
                    </div>
                </a>
                <a href="<?php echo esc_url(admin_url('admin.php?page=dsz-sync-logs&level=warning')); ?>" class="dsz-log-stat-card dsz-log-stat-warning <?php echo esc_attr($level === 'warning' ? 'active' : ''); ?>">
                    ...
                    <div class="dsz-log-stat-content">
                        ...
                        <span class="dsz-log-stat-label"><?php esc_html_e('Warnings', '3s-product-sync-for-dropshipzone'); ?></span>
                    </div>
                </a>
                <a href="<?php echo esc_url(admin_url('admin.php?page=dsz-sync-logs&level=error')); ?>" class="dsz-log-stat-card dsz-log-stat-error <?php echo esc_attr($level === 'error' ? 'active' : ''); ?>">
                    ...
                    <div class="dsz-log-stat-content">
                        ...
                        <span class="dsz-log-stat-label"><?php esc_html_e('Errors', '3s-product-sync-for-dropshipzone'); ?></span>
                    </div>
                </a>
            </div>
            ...
            <div class="dsz-content">
                ...
                <div class="dsz-logs-toolbar">
                    <div class="dsz-logs-summary">
                        <?php if ($level): ?>
                            ...
                            printf(esc_html__('Showing %1$d %2$s logs', '3s-product-sync-for-dropshipzone'), $total, ucfirst($level)); 
                            ?>
                            <a href="<?php echo esc_url(admin_url('admin.php?page=dsz-sync-logs')); ?>" class="dsz-clear-filter">
                                <?php esc_html_e('Clear filter', '3s-product-sync-for-dropshipzone'); ?>
                            </a>
                        <?php else: ?>
                            <?php 
                            /* translators: %d: total log count */
                            printf(esc_html__('Showing all %d logs', '3s-product-sync-for-dropshipzone'), $total); 
                            ?>
                        <?php endif; ?>
                    </div>
                    <div class="dsz-logs-actions">
                        <button type="button" id="dsz-export-logs" class="button">
                            <span class="dashicons dashicons-download"></span>
                            <?php esc_html_e('Export CSV', '3s-product-sync-for-dropshipzone'); ?>
                        </button>
                        <button type="button" id="dsz-clear-logs" class="button button-link-delete">
                            <span class="dashicons dashicons-trash"></span>
                            <?php esc_html_e('Clear All', '3s-product-sync-for-dropshipzone'); ?>
                        </button>
                    </div>
                </div>
                ...
                <?php if (empty($logs)): ?>
                    <div class="dsz-logs-empty">
                        ...
                        <h3><?php esc_html_e('No logs found', '3s-product-sync-for-dropshipzone'); ?></h3>
                        <p><?php esc_html_e('Activity logs will appear here as sync operations run.', '3s-product-sync-for-dropshipzone'); ?></p>
                    </div>
                <?php else: ?>
                                ...
                                <div class="dsz-log-content">
                                    ...
                                    <?php if (!empty($log['context'])): ?>
                                        <details class="dsz-log-context">
                                            <summary><?php esc_html_e('View details', '3s-product-sync-for-dropshipzone'); ?></summary>
                ...
                <?php if ($total_pages > 1): ?>
                    <div class="dsz-pagination">
                        ...
                        if ($page > 1): ?>
                            <a href="<?php echo esc_url($base_url . '&paged=' . ($page - 1)); ?>" class="button">&laquo; <?php esc_html_e('Previous', '3s-product-sync-for-dropshipzone'); ?></a>
                        <?php endif; ?>
                        
                        <span class="dsz-pagination-info">
                            <?php
                            /* translators: %1$d: current page, %2$d: total pages */
                            echo esc_html(sprintf(__('Page %1$d of %2$d', '3s-product-sync-for-dropshipzone'), $page, $total_pages));
                            ?>
                        </span>
                        
                        <?php if ($page < $total_pages): ?>
                            <a href="<?php echo esc_url($base_url . '&paged=' . ($page + 1)); ?>" class="button"><?php esc_html_e('Next', '3s-product-sync-for-dropshipzone'); ?> &raquo;</a>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
            </div>
    ...
    public function ajax_test_connection() {
        ...
        if (!dsz_current_user_can_manage()) {
            wp_send_json_error(['message' => __('Permission denied', '3s-product-sync-for-dropshipzone')]);
        }
    ...
    public function ajax_save_settings() {
        ...
        switch ($type) {
            ...
            default:
                wp_send_json_error(['message' => __('Invalid settings type', '3s-product-sync-for-dropshipzone')]);
        }

        wp_send_json_success(['message' => __('Settings saved successfully', '3s-product-sync-for-dropshipzone')]);
    }
    ...
    public function ajax_clear_logs() {
        ...
        wp_send_json_success(['message' => __('Logs cleared successfully', '3s-product-sync-for-dropshipzone')]);
    }
    ...
    public function ajax_save_advanced_price_rules() {
        ...
        wp_send_json_success([
            ...
            'message' => sprintf(__('Saved %d advanced price rules.', '3s-product-sync-for-dropshipzone'), count($clean)),
        ]);
    }
    ...
    public function ajax_save_import_template() {
        ...
        if ($name === '') {
            wp_send_json_error(['message' => __('Template name is required.', '3s-product-sync-for-dropshipzone')]);
        }

        $templates = get_option('dsz_import_templates', []);

        if (!isset($templates[$name]) && count($templates) >= 20) {
            wp_send_json_error(['message' => __('Template limit reached (20). Delete one first.', '3s-product-sync-for-dropshipzone')]);
        }
        ...
        wp_send_json_success([
            'message' => __('Template saved.', '3s-product-sync-for-dropshipzone'),
    ...
    public function ajax_delete_import_template() {
        ...
        if (!isset($templates[$name])) {
            wp_send_json_error(['message' => __('Template not found.', '3s-product-sync-for-dropshipzone')]);
        }
        ...
        wp_send_json_success([
            'message' => __('Template deleted.', '3s-product-sync-for-dropshipzone'),
            'templates' => (object) $templates,
        ]);
    }
    ...
    public function render_mapping() {
        ...
        if (!$this->product_mapper) {
            echo '<div class="notice notice-error"><p>' . esc_html__('Product Mapper not initialized.', '3s-product-sync-for-dropshipzone') . '</p></div>';
            return;
        }
        ...
        ?>
        <div class="wrap dsz-wrap">
            <?php $this->render_header(__('Product Mapping', '3s-product-sync-for-dropshipzone'), __('Map your WooCommerce products to Dropshipzone SKUs', '3s-product-sync-for-dropshipzone')); ?>
            ...
            <div class="dsz-content">
                ...
                <div class="dsz-form-section">
                    <div class="dsz-mapping-stats">
                        <div class="dsz-stat">
                            ...
                            <span><?php esc_html_e('Mapped Products', '3s-product-sync-for-dropshipzone'); ?></span>
                        </div>
                        <div class="dsz-stat dsz-stat-warning">
                            <strong><?php echo intval($unmapped_count); ?></strong>
                            <span><?php esc_html_e('Unmapped Products', '3s-product-sync-for-dropshipzone'); ?></span>
                        </div>
                        <div class="dsz-stat dsz-stat-info">
                            <strong><?php echo intval($never_synced_count); ?></strong>
                            <span><?php esc_html_e('Never Resynced', '3s-product-sync-for-dropshipzone'); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="dsz-mt-4">
                        <button type="button" id="dsz-resync-never-synced" class="button button-primary">
                            ...
                            echo esc_html(sprintf(__('Resync %d Never Synced Products', '3s-product-sync-for-dropshipzone'), $never_synced_count)); 
                            ?>
                        </button>
                    ...
                    <div class="dsz-mt-4">
                        <button type="button" id="dsz-scan-unmapped" class="button button-secondary">
                            ...
                            <?php 
                            /* translators: %d: number of products */
                            echo esc_html(sprintf(__('Scan %d Unmapped Products', '3s-product-sync-for-dropshipzone'), $unmapped_count)); 
                            ?>
                        </button>
                        <span id="dsz-scan-unmapped-status" class="dsz-ml-2"></span>
                        <p class="description dsz-mt-2">
                            <?php esc_html_e('Checks if unmapped products exist in Dropshipzone. Found products will be linked; not-found products will be marked as Non-DSZ.', '3s-product-sync-for-dropshipzone'); ?>
                        </p>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="dsz-form-section">
                    <div class="dsz-callout dsz-callout-info">
                        ...
                        <div>
                            <strong><?php esc_html_e('Looking for sync actions?', '3s-product-sync-for-dropshipzone'); ?></strong>
                            <p><?php
                            echo wp_kses_post(sprintf(
                                /* translators: %s: Link to Sync Center page */
                                __('Link products by SKU, update prices & stock, and refresh product data from the %s.', '3s-product-sync-for-dropshipzone'),
                                '<a href="' . esc_url(admin_url('admin.php?page=dsz-sync-control')) . '">' . esc_html__('Sync Center', '3s-product-sync-for-dropshipzone') . '</a>'
                            ));
                            ?></p>
                        </div>
                    </div>
                ...
                <!-- Search and Add New -->
                <div class="dsz-form-section">
                    <h2><?php esc_html_e('Add New Mapping', '3s-product-sync-for-dropshipzone'); ?></h2>
                    <div class="dsz-mapping-add">
                        <div class="dsz-mapping-field">
                            <label><?php esc_html_e('WooCommerce Product:', '3s-product-sync-for-dropshipzone'); ?></label>
                            <input type="text" id="dsz-wc-search" placeholder="<?php esc_attr_e('Search by name or SKU...', '3s-product-sync-for-dropshipzone'); ?>" />
                        ...
                        <div class="dsz-mapping-field">
                            <label><?php esc_html_e('Dropshipzone SKU:', '3s-product-sync-for-dropshipzone'); ?></label>
                            <input type="text" id="dsz-dsz-sku" placeholder="<?php esc_attr_e('Enter DSZ SKU or search...', '3s-product-sync-for-dropshipzone'); ?>" />
                        ...
                        <button type="button" id="dsz-create-mapping" class="button button-primary" disabled>
                            <?php esc_html_e('Create Mapping', '3s-product-sync-for-dropshipzone'); ?>
                        </button>
                    </div>
                ...
                <div class="dsz-form-section">
                    <div class="dsz-section-header">
                        <h2><?php esc_html_e('Existing Mappings', '3s-product-sync-for-dropshipzone'); ?></h2>
                    ...
                    <form method="get" class="dsz-mapping-search">
                        ...
                        <input type="text" name="search" value="<?php echo esc_attr($search); ?>" placeholder="<?php esc_attr_e('Search mappings...', '3s-product-sync-for-dropshipzone'); ?>" />
                        <select name="resync_filter">
                            <option value=""><?php esc_html_e('All Resync Status', '3s-product-sync-for-dropshipzone'); ?></option>
                            <option value="never" <?php selected($resync_filter, 'never'); ?>><?php esc_html_e('Never Resynced', '3s-product-sync-for-dropshipzone'); ?></option>
                            <option value="today" <?php selected($resync_filter, 'today'); ?>><?php esc_html_e('Resynced Today', '3s-product-sync-for-dropshipzone'); ?></option>
                            <option value="week" <?php selected($resync_filter, 'week'); ?>><?php esc_html_e('Last 7 Days', '3s-product-sync-for-dropshipzone'); ?></option>
                            <option value="month" <?php selected($resync_filter, 'month'); ?>><?php esc_html_e('Last 30 Days', '3s-product-sync-for-dropshipzone'); ?></option>
                            <option value="older" <?php selected($resync_filter, 'older'); ?>><?php esc_html_e('Older than 30 Days', '3s-product-sync-for-dropshipzone'); ?></option>
                        </select>
                        <button type="submit" class="button"><?php esc_html_e('Filter', '3s-product-sync-for-dropshipzone'); ?></button>
                        <?php if ($search || $resync_filter): ?>
                            <a href="<?php echo esc_url(admin_url('admin.php?page=dsz-sync-mapping')); ?>" class="button"><?php esc_html_e('Clear', '3s-product-sync-for-dropshipzone'); ?></a>
                        <?php endif; ?>
                    </form>
                    ...
                    <table class="wp-list-table widefat fixed striped">
                        <thead>
                            <tr>
                                <th><?php esc_html_e('WooCommerce Product', '3s-product-sync-for-dropshipzone'); ?></th>
                                <th><?php esc_html_e('Dropshipzone SKU', '3s-product-sync-for-dropshipzone'); ?></th>
                                <th><?php esc_html_e('Last Resynced', '3s-product-sync-for-dropshipzone'); ?></th>
                                <th class="column-actions"><?php esc_html_e('Actions', '3s-product-sync-for-dropshipzone'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if (empty($mappings)): ?>
                                <tr>
                                    <td colspan="4" class="dsz-no-logs"><?php esc_html_e('No mappings found.', '3s-product-sync-for-dropshipzone'); ?></td>
                                </tr>
                            <?php else: ?>
                                <?php foreach ($mappings as $mapping): ?>
                                    <tr data-wc-id="<?php echo esc_attr($mapping['wc_product_id']); ?>">
                                        ...
                                        <td><?php echo isset($mapping['last_resynced']) && $mapping['last_resynced'] ? esc_html(dsz_format_datetime($mapping['last_resynced'])) : esc_html__('Never', '3s-product-sync-for-dropshipzone'); ?></td>
    ...
    public function ajax_map_product() {
        ...
        if (!$wc_product_id || !$dsz_sku) {
            wp_send_json_error(['message' => __('Product ID and SKU are required', '3s-product-sync-for-dropshipzone')]);
        }

        $result = $this->product_mapper->map($wc_product_id, $dsz_sku);

        if ($result) {
            wp_send_json_success(['message' => __('Mapping created successfully', '3s-product-sync-for-dropshipzone')]);
        } else {
            wp_send_json_error(['message' => __('Failed to create mapping', '3s-product-sync-for-dropshipzone')]);
        }
    }
    ...
    public function ajax_unmap_product() {
        ...
        if (!$wc_product_id) {
            wp_send_json_error(['message' => __('Product ID is required', '3s-product-sync-for-dropshipzone')]);
        }

        $result = $this->product_mapper->unmap($wc_product_id);

        if ($result) {
            wp_send_json_success(['message' => __('Mapping removed successfully', '3s-product-sync-for-dropshipzone')]);
        } else {
            wp_send_json_error(['message' => __('Failed to remove mapping', '3s-product-sync-for-dropshipzone')]);
        }
    }
    ...
    public function ajax_auto_map() {
        ...
        wp_send_json_success([
            'message' => sprintf(
                ...
                __('Auto-mapping complete! %1$d products mapped, %2$d skipped.', '3s-product-sync-for-dropshipzone'),
                $results['mapped'],
                $results['skipped']
            ),
    ...
    public function render_import() {
        if (!dsz_current_user_can_manage()) {
            wp_die(__('You do not have permission to access this page.', '3s-product-sync-for-dropshipzone'));
        }
        ?>
        <div class="wrap dsz-wrap">
            <?php $this->render_header(__('Product Import', '3s-product-sync-for-dropshipzone'), __('Discover and import products from Dropshipzone catalog', '3s-product-sync-for-dropshipzone')); ?>

            <!-- Hero Search Section -->
            <div class="dsz-import-hero">
                <div class="dsz-import-hero-content">
                    <h2><?php esc_html_e('Find Products to Import', '3s-product-sync-for-dropshipzone'); ?></h2>
                    <p><?php esc_html_e('Search by keywords, SKU, or browse categories to find products for your store.', '3s-product-sync-for-dropshipzone'); ?></p>
                    
                    <div class="dsz-import-search-wrapper">
                        <div class="dsz-import-search-box">
                            <span class="dashicons dashicons-search"></span>
                            <input type="text" id="dsz-import-search" placeholder="<?php esc_attr_e('Enter keywords, SKU, or product name...', '3s-product-sync-for-dropshipzone'); ?>" />
                            <button type="button" id="dsz-import-search-btn" class="button button-primary button-hero">
                                <?php esc_html_e('Search Products', '3s-product-sync-for-dropshipzone'); ?>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="dsz-import-quick-filters">
                <div class="dsz-quick-filter-card" data-filter="in_stock">
                    <span class="dashicons dashicons-yes-alt"></span>
                    <span class="dsz-quick-filter-label"><?php esc_html_e('In Stock', '3s-product-sync-for-dropshipzone'); ?></span>
                </div>
                <div class="dsz-quick-filter-card" data-filter="on_promotion">
                    <span class="dashicons dashicons-tag"></span>
                    <span class="dsz-quick-filter-label"><?php esc_html_e('On Sale', '3s-product-sync-for-dropshipzone'); ?></span>
                </div>
                <div class="dsz-quick-filter-card" data-filter="free_shipping">
                    <span class="dashicons dashicons-car"></span>
                    <span class="dsz-quick-filter-label"><?php esc_html_e('Free Shipping', '3s-product-sync-for-dropshipzone'); ?></span>
                </div>
                <div class="dsz-quick-filter-card" data-filter="new_arrival">
                    <span class="dashicons dashicons-star-filled"></span>
                    <span class="dsz-quick-filter-label"><?php esc_html_e('New Arrivals', '3s-product-sync-for-dropshipzone'); ?></span>
                </div>
            </div>
            ...
            <div class="dsz-content">
                ...
                <div class="dsz-import-filters-section">
                    <button type="button" id="dsz-toggle-filters" class="dsz-toggle-filters-btn">
                        ...
                        <?php esc_html_e('Advanced Filters', '3s-product-sync-for-dropshipzone'); ?>
                    ...
                    <div id="dsz-filters-panel" class="dsz-filters-panel hidden">
                        <div class="dsz-filters-grid">
                            ...
                            <div class="dsz-filter-item">
                                <label for="dsz-filter-category"><?php esc_html_e('Category', '3s-product-sync-for-dropshipzone'); ?></label>
                                <div class="dsz-filter-select-wrapper">
                                    <select id="dsz-filter-category">
                                        <option value=""><?php esc_html_e('All Categories', '3s-product-sync-for-dropshipzone'); ?></option>
                                    </select>
                                    <button type="button" id="dsz-load-categories" class="button button-small" title="<?php esc_attr_e('Load categories from API', '3s-product-sync-for-dropshipzone'); ?>">
                                        <span class="dashicons dashicons-update"></span>
                                    </button>
                                </div>
                            </div>
                            ...
                            <!-- Sort Options -->
                            <div class="dsz-filter-item">
                                <label for="dsz-filter-sort"><?php esc_html_e('Sort By', '3s-product-sync-for-dropshipzone'); ?></label>
                                <select id="dsz-filter-sort">
                                    <option value=""><?php esc_html_e('Default', '3s-product-sync-for-dropshipzone'); ?></option>
                                    <option value="price_asc"><?php esc_html_e('Price: Low to High', '3s-product-sync-for-dropshipzone'); ?></option>
                                    <option value="price_desc"><?php esc_html_e('Price: High to Low', '3s-product-sync-for-dropshipzone'); ?></option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="dsz-filter-item dsz-mt-3">
                            <label for="dsz-import-template"><?php esc_html_e('Filter Templates', '3s-product-sync-for-dropshipzone'); ?></label>
                            <div class="dsz-flex-row">
                                <select id="dsz-import-template">
                                    <option value=""><?php esc_html_e('&mdash; Select template &mdash;', '3s-product-sync-for-dropshipzone'); ?></option>
                                ...
                                <input type="text" id="dsz-import-template-name" placeholder="<?php esc_attr_e('Template name', '3s-product-sync-for-dropshipzone'); ?>" />
                                <button type="button" id="dsz-save-template" class="button"><?php esc_html_e('Save Current', '3s-product-sync-for-dropshipzone'); ?></button>
                                <button type="button" id="dsz-delete-template" class="button dsz-btn-danger"><?php esc_html_e('Delete', '3s-product-sync-for-dropshipzone'); ?></button>
                            </div>
                        </div>
                        ...
                        <div class="dsz-filters-actions">
                            <button type="button" id="dsz-apply-filters" class="button button-primary">
                                ...
                                <?php esc_html_e('Apply Filters', '3s-product-sync-for-dropshipzone'); ?>
                            </button>
                ...
                <div id="dsz-import-results" class="dsz-import-results-container">
                    <div class="dsz-import-empty">
                        ...
                        <h3><?php esc_html_e('Ready to Import', '3s-product-sync-for-dropshipzone'); ?></h3>
                        <p><?php esc_html_e('Search for products or click a quick filter above to browse the Dropshipzone catalog.', '3s-product-sync-for-dropshipzone'); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    public function ajax_search_api_products() {
        ...
        if (empty($products)) {
            ...
            $message = __('No products found.', '3s-product-sync-for-dropshipzone');
            if (!empty($search)) {
                $message .= ' ' . __('Try different keywords or adjust filters.', '3s-product-sync-for-dropshipzone');
            } else {
                $message .= ' ' . __('Try adjusting your filters.', '3s-product-sync-for-dropshipzone');
            }
    ...
    public function ajax_get_categories() {
        ...
        if (empty($categories)) {
            ...
            wp_send_json_error(['message' => __('No categories found from API.', '3s-product-sync-for-dropshipzone')]);
        }
    ...
    public function ajax_import_product() {
        ...
        if (!$sku) {
            wp_send_json_error(['message' => __('SKU is required', '3s-product-sync-for-dropshipzone')]);
        }
        ...
        wp_send_json_success([
            'message' => __('Product imported successfully!', '3s-product-sync-for-dropshipzone'),
            'product_id' => $result,
    ...
    public function ajax_resync_product() {
        ...
        if (!$product_id && !$sku) {
            wp_send_json_error(['message' => __('Product ID or SKU is required', '3s-product-sync-for-dropshipzone')]);
        }
        ...
        if (!$product_id && $sku) {
            ...
            if (!$product_id) {
                wp_send_json_error(['message' => __('Product not found in WooCommerce', '3s-product-sync-for-dropshipzone')]);
            }
        }
        ...
        wp_send_json_success([
            'message' => __('Product resynced successfully!', '3s-product-sync-for-dropshipzone'),
            'product_id' => $result,
            'edit_url' => get_edit_post_link($result, 'url')
        ]);
    }
    ...
    private function resync_mapping_chunk($mappings, $options) {
        ...
        foreach ($mappings as $mapping) {
            ...
            if (!isset($api_products[$sku])) {
                $errors++;
                $error_details[] = sprintf('%s: %s', $sku, __('Not found in Dropshipzone API', '3s-product-sync-for-dropshipzone'));
                continue;
            }
    ...
    public function ajax_resync_all() {
        ...
        if ($total === 0) {
            wp_send_json_error(['message' => __('No mapped products found to resync.', '3s-product-sync-for-dropshipzone')]);
        }
    ...
    private function resync_specific($type) {
        ...
        if ($total === 0) {
            wp_send_json_error(['message' => __('No mapped products found.', '3s-product-sync-for-dropshipzone')]);
        }
    ...
    public function ajax_scan_unmapped_products() {
        ...
        if (empty($unmapped_products)) {
            wp_send_json_success([
                'message' => __('No unmapped products to scan.', '3s-product-sync-for-dropshipzone'),
                'done' => true,
                'found' => 0,
                'not_found' => 0,
            ]);
        ...
        foreach ($all_skus as $sku) {
            ...
            if (isset($api_products[$sku])) {
                ...
                if ($mapping_result) {
                    ...
                    $errors[] = sprintf('%s: %s', $sku, __('Failed to create mapping', '3s-product-sync-for-dropshipzone'));
                }
            } else {
        ...
        $message = sprintf(
            __('Scan complete! %1$d products linked to Dropshipzone, %2$d marked as non-DSZ products.', '3s-product-sync-for-dropshipzone'),
            $found_count,
            $not_found_count
        );
    ...
    public function ajax_submit_order() {
        ...
        if (!$order_id) {
            wp_send_json_error(['message' => __('Order ID required.', '3s-product-sync-for-dropshipzone')]);
        }

        if (!$this->order_handler) {
            wp_send_json_error(['message' => __('Order handler not initialized.', '3s-product-sync-for-dropshipzone')]);
        }
    ...
    public function ajax_run_tracking_sync() {
        ...
        wp_send_json_success([
            ...
            'message' => sprintf(__('Tracking checked for %1$d orders, %2$d updated.', '3s-product-sync-for-dropshipzone'), $results['checked'], $results['updated']),
            'results' => $results,
        ]);
    }
    ...
    public function register_order_bulk_action($actions) {
        $actions['dsz_submit_orders'] = __('Submit to Dropshipzone', '3s-product-sync-for-dropshipzone');
        return $actions;
    }
    ...
    public function order_bulk_action_notice() {
        ...
        printf(
            ...
            esc_html(sprintf(
                ...
                __('Dropshipzone: %1$d orders submitted, %2$d failed (see order notes / logs).', '3s-product-sync-for-dropshipzone'),
                $submitted,
                $errors
            ))
        );
    ...
    public function add_product_margin_column($columns) {
        $columns['dsz_margin'] = __('DSZ Margin', '3s-product-sync-for-dropshipzone');
        return $columns;
    }
    ...
    public function add_order_meta_box() {
        ...
        add_meta_box(
            'dsz-order-meta-box',
            __('Dropshipzone Order', '3s-product-sync-for-dropshipzone'),
    ...
    public function render_order_meta_box($post_or_order) {
        ...
        if (!$order) {
            echo '<p>' . esc_html__('Order not found.', '3s-product-sync-for-dropshipzone') . '</p>';
            return;
        }
        ...
        if (!$this->order_handler) {
            echo '<p>' . esc_html__('Order handler not available.', '3s-product-sync-for-dropshipzone') . '</p>';
            return;
        }
        ...
        if (!$has_dsz_products) {
            echo '<p class="dsz-text-muted">' . esc_html__('No Dropshipzone products in this order.', '3s-product-sync-for-dropshipzone') . '</p>';
            return;
        }
        ...
        <div class="dsz-order-box">
            ...
            ?>
                <p>
                    <strong><?php esc_html_e('DSZ Serial:', '3s-product-sync-for-dropshipzone'); ?></strong><br>
                    <code><?php echo esc_html($serial); ?></code>
                </p>
                <p>
                    <strong><?php esc_html_e('Status:', '3s-product-sync-for-dropshipzone'); ?></strong><br>
                ...
                <p>
                    <strong><?php esc_html_e('Submitted:', '3s-product-sync-for-dropshipzone'); ?></strong><br>
                ...
                <?php if ($tracking): ?>
                <p>
                    <strong><?php esc_html_e('Tracking:', '3s-product-sync-for-dropshipzone'); ?></strong><br>
            ...
            <?php elseif ($dsz_order && !empty($dsz_order['error_message'])): ?>
                <p class="dsz-error">
                    <strong><?php esc_html_e('Last Error:', '3s-product-sync-for-dropshipzone'); ?></strong><br>
                ...
                <button type="button" class="button button-primary dsz-submit-order-btn" data-order-id="<?php echo esc_attr($order_id); ?>">
                    <span class="dashicons dashicons-update"></span>
                    <?php esc_html_e('Retry Submit', '3s-product-sync-for-dropshipzone'); ?>
                </button>
            <?php else: ?>
                <p><?php esc_html_e('This order has Dropshipzone products and can be submitted.', '3s-product-sync-for-dropshipzone'); ?></p>
                <button type="button" class="button button-primary dsz-submit-order-btn" data-order-id="<?php echo esc_attr($order_id); ?>">
                    <span class="dashicons dashicons-upload"></span>
                    <?php esc_html_e('Submit to Dropshipzone', '3s-product-sync-for-dropshipzone'); ?>
                </button>
            <?php endif; ?>
            <?php
            ...
            <p>
                <strong><?php esc_html_e('Est. Item Profit:', '3s-product-sync-for-dropshipzone'); ?></strong><br>
                ...
                <span class="dsz-text-muted"><?php esc_html_e('excl. DSZ shipping', '3s-product-sync-for-dropshipzone'); ?></span>
                <?php if (!$profit_known): ?><br><span class="dsz-text-muted"><?php esc_html_e('Some supplier costs unknown — run a sync to populate them.', '3s-product-sync-for-dropshipzone'); ?></span><?php endif; ?>
            </p>
            <?php endif; ?>
    ...
    public function render_auto_import() {
        ...
        ?>
        <div class="wrap dsz-wrap">
            <?php $this->render_header(__('Auto Import', '3s-product-sync-for-dropshipzone'), __('Automatically import new products from Dropshipzone', '3s-product-sync-for-dropshipzone')); ?>
            ...
            <div class="dsz-content">
                <form id="dsz-auto-import-form" class="dsz-form">
                    ...
                    <!-- Status Section -->
                    <div class="dsz-form-section">
                        <h2><?php esc_html_e('Auto Import Status', '3s-product-sync-for-dropshipzone'); ?></h2>
                        <div class="dsz-cards">
                            <div class="dsz-card <?php echo esc_attr($settings['enabled'] ? 'dsz-card-success' : 'dsz-card-warning'); ?>">
                                ...
                                <div class="dsz-card-content">
                                    <h3><?php esc_html_e('Status', '3s-product-sync-for-dropshipzone'); ?></h3>
                                    <p class="dsz-card-value"><?php echo esc_html($settings['enabled'] ? __('Enabled', '3s-product-sync-for-dropshipzone') : __('Disabled', '3s-product-sync-for-dropshipzone')); ?></p>
                                </div>
                            </div>
                            <div class="dsz-card">
                                <div class="dsz-card-icon">
                                ...
                                <div class="dsz-card-content">
                                    <h3><?php esc_html_e('Next Run', '3s-product-sync-for-dropshipzone'); ?></h3>
                                    <p class="dsz-card-value"><?php echo $next_scheduled ? esc_html(dsz_time_ago($next_scheduled)) : esc_html__('Not Scheduled', '3s-product-sync-for-dropshipzone'); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="dsz-card">
                                ...
                                <div class="dsz-card-content">
                                    <h3><?php esc_html_e('Last Run', '3s-product-sync-for-dropshipzone'); ?></h3>
                                    <p class="dsz-card-value"><?php echo isset($status['last_results']['imported']) ? intval($status['last_results']['imported']) : 0; ?> <?php esc_html_e('imported', '3s-product-sync-for-dropshipzone'); ?></p>
                        ...
                        <div class="dsz-form-actions dsz-mb-5">
                            <button type="button" id="dsz-run-auto-import" class="button button-secondary">
                                <span class="dashicons dashicons-download"></span>
                                <?php esc_html_e('Run Import Now', '3s-product-sync-for-dropshipzone'); ?>
                            </button>
                    ...
                    ?>
                    <div class="dsz-form-section">
                        <h2><?php esc_html_e('Import Metrics', '3s-product-sync-for-dropshipzone'); ?></h2>
                        <div class="dsz-cards">
                            <div class="dsz-card">
                                ...
                                <div class="dsz-card-content">
                                    <h3><?php esc_html_e('Mapped Products', '3s-product-sync-for-dropshipzone'); ?></h3>
                                    <p class="dsz-card-value"><?php echo intval($realtime_count); ?></p>
                                    <p class="dsz-card-meta"><?php esc_html_e('in database (live)', '3s-product-sync-for-dropshipzone'); ?></p>
                                </div>
                            </div>
                            <div class="dsz-card">
                                <div class="dsz-card-icon">
                                ...
                                <div class="dsz-card-content">
                                    <h3><?php esc_html_e('Auto Imported', '3s-product-sync-for-dropshipzone'); ?></h3>
                                    <p class="dsz-card-value"><?php echo isset($stats['total_imported']) ? intval($stats['total_imported']) : 0; ?></p>
                                    <p class="dsz-card-meta"><?php echo isset($stats['total_runs']) ? intval($stats['total_runs']) : 0; ?> <?php esc_html_e('runs', '3s-product-sync-for-dropshipzone'); ?></p>
                                </div>
                            </div>
                            <div class="dsz-card">
                                <div class="dsz-card-icon">
                                ...
                                <div class="dsz-card-content">
                                    <h3><?php esc_html_e('Last 7 Days', '3s-product-sync-for-dropshipzone'); ?></h3>
                                    <p class="dsz-card-value"><?php echo intval($stats['last_7_days']['imported']); ?></p>
                                    <p class="dsz-card-meta"><?php echo intval($stats['last_7_days']['runs']); ?> <?php esc_html_e('runs', '3s-product-sync-for-dropshipzone'); ?></p>
                                </div>
                            </div>
                            <div class="dsz-card">
                                <div class="dsz-card-icon">
                                ...
                                <div class="dsz-card-content">
                                    <h3><?php esc_html_e('Last 30 Days', '3s-product-sync-for-dropshipzone'); ?></h3>
                                    <p class="dsz-card-value"><?php echo intval($stats['last_30_days']['imported']); ?></p>
                                    <p class="dsz-card-meta"><?php echo intval($stats['last_30_days']['runs']); ?> <?php esc_html_e('runs', '3s-product-sync-for-dropshipzone'); ?></p>
                                </div>
                            </div>
                        </div>
                        
                        <?php if (!empty($history)): ?>
                        <h3><?php esc_html_e('Recent Import History', '3s-product-sync-for-dropshipzone'); ?></h3>
                        <table class="widefat striped dsz-mb-5">
                            <thead>
                                <tr>
                                    <th><?php esc_html_e('Date', '3s-product-sync-for-dropshipzone'); ?></th>
                                    <th><?php esc_html_e('Imported', '3s-product-sync-for-dropshipzone'); ?></th>
                                    <th><?php esc_html_e('Skipped', '3s-product-sync-for-dropshipzone'); ?></th>
                                    <th><?php esc_html_e('Errors', '3s-product-sync-for-dropshipzone'); ?></th>
                                    <th><?php esc_html_e('Status', '3s-product-sync-for-dropshipzone'); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($entry['status'] === 'complete'): ?>
                                            <span class="dsz-text-success"><span class="dashicons dashicons-yes-alt"></span> <?php esc_html_e('Complete', '3s-product-sync-for-dropshipzone'); ?></span>
                                        <?php elseif ($entry['status'] === 'error'): ?>
                                            <span class="dsz-text-error"><span class="dashicons dashicons-warning"></span> <?php esc_html_e('Error', '3s-product-sync-for-dropshipzone'); ?></span>
                                        <?php else: ?>
                        ...
                        <?php else: ?>
                        <p class="dsz-text-muted"><?php esc_html_e('No import history yet. Run an import to see metrics.', '3s-product-sync-for-dropshipzone'); ?></p>
                        <?php endif; ?>
                    </div>

                    <!-- Settings Section -->
                    <div class="dsz-form-section">
                        <h2><?php esc_html_e('Auto Import Settings', '3s-product-sync-for-dropshipzone'); ?></h2>
                        
                        <table class="form-table">
                            <tr>
                                <th scope="row"><?php esc_html_e('Enable Auto Import', '3s-product-sync-for-dropshipzone'); ?></th>
                                <td>
                                    <label>
                                        <input type="checkbox" name="enabled" value="1" <?php checked($settings['enabled'], true); ?> />
                                        <?php esc_html_e('Automatically import new products on schedule', '3s-product-sync-for-dropshipzone'); ?>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                    <label for="frequency"><?php esc_html_e('Import Frequency', '3s-product-sync-for-dropshipzone'); ?></label>
                                </th>
                                <td>
                                    <select name="frequency" id="frequency">
                                        <option value="hourly" <?php selected($settings['frequency'], 'hourly'); ?>><?php esc_html_e('Every Hour', '3s-product-sync-for-dropshipzone'); ?></option>
                                        <option value="twicedaily" <?php selected($settings['frequency'], 'twicedaily'); ?>><?php esc_html_e('Twice Daily', '3s-product-sync-for-dropshipzone'); ?></option>
                                        <option value="daily" <?php selected($settings['frequency'], 'daily'); ?>><?php esc_html_e('Once Daily', '3s-product-sync-for-dropshipzone'); ?></option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                    <label for="max_products_per_run"><?php esc_html_e('Max Products Per Run', '3s-product-sync-for-dropshipzone'); ?></label>
                                </th>
                                <td>
                                    ...
                                    <p class="description"><?php esc_html_e('Maximum number of products to import per scheduled run (1-200)', '3s-product-sync-for-dropshipzone'); ?></p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                    <label for="min_stock_qty"><?php esc_html_e('Minimum Stock Quantity', '3s-product-sync-for-dropshipzone'); ?></label>
                                </th>
                                <td>
                                    ...
                                    <p class="description"><?php esc_html_e('Only import products with at least this many units in stock (default: 100)', '3s-product-sync-for-dropshipzone'); ?></p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                    <label for="default_product_status"><?php esc_html_e('Default Product Status', '3s-product-sync-for-dropshipzone'); ?></label>
                                </th>
                                <td>
                                    <select name="default_product_status" id="default_product_status">
                                        <option value="publish" <?php selected($settings['default_product_status'], 'publish'); ?>><?php esc_html_e('Published', '3s-product-sync-for-dropshipzone'); ?></option>
                                        <option value="draft" <?php selected($settings['default_product_status'], 'draft'); ?>><?php esc_html_e('Draft', '3s-product-sync-for-dropshipzone'); ?></option>
                                        <option value="pending" <?php selected($settings['default_product_status'], 'pending'); ?>><?php esc_html_e('Pending Review', '3s-product-sync-for-dropshipzone'); ?></option>
                                    </select>
                                    <p class="description"><?php esc_html_e('Status for newly imported products', '3s-product-sync-for-dropshipzone'); ?></p>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <!-- Filters Section -->
                    <div class="dsz-form-section">
                        <h2><?php esc_html_e('Import Filters', '3s-product-sync-for-dropshipzone'); ?></h2>
                        <p class="description"><?php esc_html_e('Only products matching these filters will be imported.', '3s-product-sync-for-dropshipzone'); ?></p>
                        
                        <table class="form-table">
                            <tr>
                                <th scope="row"><?php esc_html_e('New Arrivals Only', '3s-product-sync-for-dropshipzone'); ?></th>
                                <td>
                                    <label>
                                        <input type="checkbox" name="filter_new_arrival" value="1" <?php checked($settings['filter_new_arrival'], true); ?> />
                                        <?php esc_html_e('Only import products marked as new arrivals', '3s-product-sync-for-dropshipzone'); ?>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><?php esc_html_e('In Stock Only', '3s-product-sync-for-dropshipzone'); ?></th>
                                <td>
                                    <label>
                                        <input type="checkbox" name="filter_in_stock" value="1" <?php checked($settings['filter_in_stock'], true); ?> />
                                        <?php esc_html_e('Only import products that are currently in stock', '3s-product-sync-for-dropshipzone'); ?>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><?php esc_html_e('Free Shipping Only', '3s-product-sync-for-dropshipzone'); ?></th>
                                <td>
                                    <label>
                                        <input type="checkbox" name="filter_free_shipping" value="1" <?php checked($settings['filter_free_shipping'], true); ?> />
                                        <?php esc_html_e('Only import products with free shipping in Australia', '3s-product-sync-for-dropshipzone'); ?>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><?php esc_html_e('Supplier Blacklist', '3s-product-sync-for-dropshipzone'); ?></th>
                                <td>
                                    <input type="text" name="exclude_supplier_ids" class="regular-text" value="<?php echo esc_attr(isset($settings['exclude_supplier_ids']) ? $settings['exclude_supplier_ids'] : ''); ?>" placeholder="<?php esc_attr_e('e.g. 201,305,412', '3s-product-sync-for-dropshipzone'); ?>" />
                                    <p class="description"><?php esc_html_e('Comma-separated supplier IDs to exclude from imports (max 50). Find the supplier ID in the product data as vendor_id.', '3s-product-sync-for-dropshipzone'); ?></p>
                                </td>
                            </tr>
                        </table>
                    </div>
    ...
    public function ajax_run_auto_import() {
        ...
        if (!$this->auto_importer) {
            wp_send_json_error(['message' => __('Auto importer not initialized', '3s-product-sync-for-dropshipzone')]);
        }
